namespace midspace.adminscripts
{
    ...
    public class CommandInventoryDrop : ChatCommand
    {
        ...
        public CommandInventoryDrop(string[] oreNames, string[] ingotNames, MyPhysicalItemDefinition[] physicalItems, Dictionary<MyTextsWrapperEnum, string> resouceLookup)
