    ...
    public class CommandShipOwnerRevoke : ChatCommand
    {
        ...
        public override bool Invoke(ulong steamId, long playerId, string messageText)
        {
            if (messageText.Equals("/revoke", StringComparison.InvariantCultureIgnoreCase))
            {
                ...
                if (shipEntity != null)
                {
                    MessageSyncGridChange.SendMessage(SyncGridChangeType.OwnerRevoke, shipEntity.EntityId, null, MyAPIGateway.Session.Player.IdentityId);
                    return true;
                }
            ...
            if (match.Success)
            {
                ...
                MessageSyncGridChange.SendMessage(SyncGridChangeType.OwnerRevoke, 0, shipName, MyAPIGateway.Session.Player.IdentityId);
                return true;
            }
